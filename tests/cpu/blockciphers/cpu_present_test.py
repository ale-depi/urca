...
def test_present_memory_optimized(block_size, key_size, n_rounds, plaintexts, keys, ciphertexts):
    present = Present(block_size, key_size)
    blocks = np.array(plaintexts, present.word_type)
    keys = np.array(keys, present.word_type)
    # encryption test
